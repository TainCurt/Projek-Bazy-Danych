...
from DominoApp.views.frontend import custom_login_view, home, dashboard_view, buildings_list_view, building_details_view, flat_details_view, profile_view, announcements_view, my_flats_view, my_rents_view, my_reports_view, admin_reports_view, admin_users_view, debt_stats_view
...
urlpatterns=[
    ...
    path('debt-stats/', debt_stats_view, name='debt-stats'),
]